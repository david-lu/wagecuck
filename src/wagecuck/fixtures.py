...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if path == "/screening":
            ...
            <fieldset><legend>Preferred pronouns *</legend><label>She/Her<input type="radio" name="pronouns" value="she" required></label><label>They/Them<input type="radio" name="pronouns" value="they" required></label></fieldset>
            <fieldset><legend>Gender identity *</legend><label>Man<input type="radio" name="gender" value="man" required></label><label>Non-binary<input type="radio" name="gender" value="nonbinary" required></label><label>Prefer not to say<input type="radio" name="gender" value="decline" required></label></fieldset>
            <label>Sexual orientation *<select name="orientation" required><option value="">Choose</option><option value="straight">Straight</option><option value="bisexual">Bisexual</option></select></label>
            <label>Do you identify as transgender? *<select name="transgender" required><option value="">Choose</option><option value="yes">Yes</option><option value="no">No</option></select></label>
            <div class="application-question"><h3>Race or ethnicity *</h3><label>Asian<input type="checkbox" name="race_asian" value="asian"></label><label>White<input type="checkbox" name="race_white" value="white"></label></div>
            <fieldset><legend>Are you Hispanic or Latino? *</legend><label>Yes<input type="radio" name="hispanic" value="yes" required></label><label>No<input type="radio" name="hispanic" value="no" required></label></fieldset>"""
        if path == "/mutating":

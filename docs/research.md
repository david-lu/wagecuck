...
## Training/validation expansion, September 16, 2026

The corpus now has an explicit development/holdout boundary. Eight current postings were added to the training split after their public application metadata had been reviewed: [DoorDash](https://job-boards.greenhouse.io/doordashusa/jobs/5630445), [Applied Intuition](https://job-boards.greenhouse.io/appliedintuition/jobs/4510436005), [Accenture Federal Services](https://job-boards.greenhouse.io/accenturefederalservices/jobs/4700296006), [Total Life](https://apply.workable.com/total-life/j/84F61216A8/apply/), [Devsinc](https://apply.workable.com/devsinc-17/j/95442E6391/apply/), [CENTRL](https://centrl.breezy.hr/p/5f71fbede25a-software-engineer/apply), [UtilityAPI](https://utilityapi.breezy.hr/p/7c161dbb2af0-senior-staff-software-engineer-ai-systems-platform), and [ClearRoute](https://clearroute.teamtailor.com/jobs/8261776-agentic-ai-developer-python).

Eight separate current postings were selected as validation cases using only listing identity, ATS family and role availability. Their field metadata was not used to change parser, mapper, prompt, profile or browser behavior. They cover three Ashby employers plus independent Breezy, Teamtailor, Workable, Greenhouse and Lever employers. The exact URLs and non-leakage tokens are in [the validation manifest](../examples/validation-jobs.json); the handling protocol is in [the evaluation guide](evaluation.md).
